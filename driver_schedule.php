...
<head>
    ...
    <style>
        body {
            ...
            color: #222; /* ✅ Soft color matching background */
        }
        .container-box {
            background: rgba(255, 255, 255, 0.3); /* ✅ Softer transparency */
            padding: 25px;
            border-radius: 12px;
            max-width: 900px;
            margin: 85px auto; /* ✅ Moved lower */
        ...
        .table th {
            background: rgba(0, 131, 116, 0.85); /* ✅ More visible */
            color: #fff;
        }
        .table td {
