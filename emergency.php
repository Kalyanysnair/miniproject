...
<div class="container mt-5">
    <div class="form-container">
        ...
        <form action="" method="post" class="php-email-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="row gy-4">
                <!-- Patient/Booker Name -->
                <div class="col-md-6">
...
<script>
    ...
    function showLocationOptions() {
        ...
        if (method === "current") document.getElementById("current-location").style.display = "block";
        if (method === "map") document.getElementById("map-location").style.display = "block";
    }
